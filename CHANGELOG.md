...
* улучшен поиск по полной строке
* экранируются аргументы фильтров и сортировок

## [1.10.10] - 2024-03-18

### Добавлено

* приоритетный поиск по всему значению поисковой строки

## [1.10.9] - 2023-03-14

### Исправлено

* исключение неиндексированных полей из процесса формирования запроса

### Изменено

* обновление библиотеки взаимодействия с ES: `MyLab.Search.EsAdapter v1.5.21` ->  `MyLab.Search.EsAdapter v2.1.5` 
