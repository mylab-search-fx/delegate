...
namespace FunctionTests.V3
{
        ...
        IAsyncLifetime
    {
        ...
        private readonly TestApi<Startup, ISearchDelegateApiV3> _client;
            ...
            ITestOutputHelper output)
        {
            ...
            _client = new TestApi<Startup, ISearchDelegateApiV3>()
            {
        ...
        ISearchDelegateApiV3 StartApi(string indexName)
        {
